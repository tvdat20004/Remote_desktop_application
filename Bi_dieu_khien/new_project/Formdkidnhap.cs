...
namespace new_project
{
    public partial class Formdkidnhap : Form
    {
        ...
        private void btndangnhap_Click(object sender, EventArgs e)
        {
            ...
            // Send the serialized JSON(information about login) byte array over the TCP network
        ...
        // if register or login success or not ?
        ...
        private void btndangky_Click(object sender, EventArgs e)
        {
            ...
            //MessageBox.Show(jsonString);
            // Send the serialized JSON(informaition about register) byte array over the TCP network
            stream.Write(messageBytes, 0, messageBytes.Length);
            if(connected() == false)
            {
                return;
